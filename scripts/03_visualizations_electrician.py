...
# -----------------------------
df = pd.read_csv("data/clean/electrician_ai_exposure_model.csv")
...
plt.title("Electrician Tasks by Category")
plt.ylabel("Number of Tasks")
plt.xlabel("Task Category")
plt.xticks(rotation=45, ha="right")
plt.tight_layout()
plt.savefig("figures/electrician_task_count_by_category.png")
plt.close()
...
plt.xticks(rotation=45, ha="right")
plt.tight_layout()
plt.savefig("figures/electrician_ai_exposure_by_category.png")
plt.close()
...
plt.title("Task-Level Contribution to AI Exposure (Electricians)")
plt.xlabel("Contribution to AI Exposure Index")
plt.tight_layout()
plt.savefig("figures/electrician_task_contributions.png")
plt.close()
...
plt.ylabel("AI Exposure Score")
plt.tight_layout()
plt.savefig("figures/electrician_weight_vs_ai_exposure.png")
plt.close()

print("All electrician visualizations saved to figures/")